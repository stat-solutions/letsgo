...
@Component({
  ...
  templateUrl: './content-section-central.component.html',
  styleUrls: ['./content-section-central.component.scss']
})
export class ContentSectionCentralComponent implements OnInit {
